...
export const coreTables = { users, bugConversations, conversationMessages, bugReports, bugAttachments, bugEvents, jobs, agentRuns, workerEvents, weeklyReportDeliveries };
