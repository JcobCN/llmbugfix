...
export const BugReportSchema = z.object({
  ...
  dev_env_snapshot: z.string().trim().min(1).optional(), dev_env_special: z.string().trim().min(1).optional(),
